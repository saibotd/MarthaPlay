...
export default class Screensaver extends React.Component {
    ...
    componentDidMount() {
        ...
        this.interval = setInterval(() => {
            this.setState({ time: moment().format(this.props.timeFormat) });
        }, 1000);
    }
